...
//|------------------- |------ |-------------:|-----------:|-----------:|-------:|------:|------:|----------:|
//|      HashSet_4byte |     0 |     23.27 ns |   0.087 ns |   0.077 ns |      - |     - |     - |         - |
//|     HashSet_32byte |     0 |     34.75 ns |   0.125 ns |   0.117 ns |      - |     - |     - |         - |
//|    HashSet_128byte |     0 |     57.63 ns |   0.300 ns |   0.266 ns |      - |     - |     - |         - |
//|    HashSet_384byte |     0 |     98.98 ns |   0.230 ns |   0.204 ns |      - |     - |     - |         - |
//|      HashSet_4byte |     1 |     26.64 ns |   0.138 ns |   0.129 ns |      - |     - |     - |         - |
//|     HashSet_32byte |     1 |     38.52 ns |   0.139 ns |   0.130 ns |      - |     - |     - |         - |
//|    HashSet_128byte |     1 |     65.93 ns |   0.146 ns |   0.130 ns |      - |     - |     - |         - |
//|    HashSet_384byte |     1 |    109.62 ns |   0.549 ns |   0.514 ns |      - |     - |     - |         - |
//|      HashSet_4byte |    10 |     81.06 ns |   1.286 ns |   1.203 ns | 0.0139 |     - |     - |      88 B |
//|     HashSet_32byte |    10 |    119.39 ns |   1.025 ns |   0.959 ns | 0.0587 |     - |     - |     368 B |
//|    HashSet_128byte |    10 |    468.05 ns |   1.428 ns |   1.336 ns | 0.0458 |     - |     - |     288 B |
//|    HashSet_384byte |    10 |    661.74 ns |   2.072 ns |   1.837 ns | 0.0458 |     - |     - |     288 B |
//|      HashSet_4byte |   100 |    711.99 ns |   4.331 ns |   4.051 ns | 0.0973 |     - |     - |     616 B |
//|     HashSet_32byte |   100 |  1,135.33 ns |   2.548 ns |   2.383 ns | 0.1602 |     - |     - |    1008 B |
//|    HashSet_128byte |   100 |  4,495.34 ns |  20.492 ns |  17.112 ns | 0.5035 |     - |     - |    3168 B |
//|    HashSet_384byte |   100 |  6,420.26 ns |  27.941 ns |  26.136 ns | 0.5035 |     - |     - |    3168 B |
//|      HashSet_4byte |  1000 | 11,107.25 ns |  84.302 ns |  78.856 ns | 0.7935 |     - |     - |    4984 B |
//|     HashSet_32byte |  1000 | 13,079.25 ns |  76.962 ns |  71.990 ns | 0.8545 |     - |     - |    5432 B |
//|    HashSet_128byte |  1000 | 46,346.29 ns | 168.816 ns | 157.910 ns | 5.0659 |     - |     - |   31968 B |
//|    HashSet_384byte |  1000 | 72,511.11 ns | 433.272 ns | 405.282 ns | 5.0049 |     - |     - |   31968 B |
